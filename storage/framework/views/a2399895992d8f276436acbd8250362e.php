    ...
    <div class id="smooth-wrapper">
        ...
        <div id="smooth-content">
            ...
            <main>
                    ...
                    <div class="container bg-card">
                        ...
                        <div class="row justify-content-center pt-4 p-5 ">
                            <div class="col-md-3 col-sm-6 pt-3">
                                <div class="card h-100">
                                    <div class="card-body p-3">
                                        <img src="<?php echo e(asset('assets/img/why-icon-1.png')); ?>" alt="Card image card-image"
                                            class="img-fluid">
                                        <div>
                            ...
                            <div class="col-md-3 col-sm-6 pt-3">
                                <div class="card h-100">
                                    <div class="card-body p-3">
                                        ...
                                        <img src="<?php echo e(asset('assets/img/why-icon-2.png')); ?>" alt="Card image"
                                            class="img-fluid mb-3">
                                        <div>
                            ...
                            <div class="col-md-3 col-sm-6 pt-3">
                                <div class="card h-100">
                                    <div class="card-volume">
                                        <img src="<?php echo e(asset('assets/img/volume-shape.png')); ?>" alt="Card image  card-image"
                                            class="img-fluid mb-3">
                                    </div>
                                    <div class="card-body p-3">
                                        <img src="<?php echo e(asset('assets/img/why-icon-3.png')); ?>" alt="Card image"
                                            class="img-fluid mb-3">
                                        <div>
                            ...
                            <div class="col-md-3 col-sm-6 pt-3">
                                <div class="card h-100">
                                    ...
                                    <div class="card-body p-3">
                                        <img src="<?php echo e(asset('assets/img/why-icon-4.png')); ?>" alt="Card image"
                                            class="img-fluid mb-3">
                                        <div>
                ...
                <section class="about_section container py-5 mt-5">
                    <div class="row g-5">
                        <div class="col-lg-6 aboutImage position-relative">
                            <img src="<?php echo e(asset('assets/img/about-image.jpg')); ?>" alt="Card image" class="img-fluid p-3"
                                style="border: 3px solid #6e05ff; border-radius: 8px; ">
                        </div>
                        <div class="col-lg-6 px-4">
                            ...
                            <h5>The beginning</h5>
                            <p>The company was established by experienced professionals with extensive expertise and
...
</html><?php /**PATH C:\Users\User\riz-technology\resources\views/index.blade.php ENDPATH**/ ?>
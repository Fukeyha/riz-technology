                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12 text-center">
                                ...
                                <!-- Paragraph animation -->
                                <p class="pt-2 wow animate__animated animate__bounceInDown" data-wow-duration="1.5s"
                                    data-wow-delay="0.5s">
                                    At RIZ Technologies, we distinguish ourselves through our extensive
                                    range of IT solutions and advanced technologies. Our exceptional offerings include
                                    cloud computing,
                                ...
                                <div class="flex-md-row justify-content-center gap-4 p-3">
                                    <a href="#" class="btn main-btn wow animate__animated animate__zoomIn"
                                        data-wow-duration="3s" data-wow-delay="3s">Get Started</a>
                                    <a href="#"
                                        class="btn btn-outline-light-custom wow animate__animated animate__zoomIn"
                                        data-wow-duration="3s" data-wow-delay="3s">Learn More</a>
                                </div>
                    ...
                    <div class="container">
                        <div class="row partner_bg mt-5 pt-5">
                            ...
                            <div class="col-lg-4 partner_column2 position-relative">
                                <div class="partner4">
                                    <img src="<?php echo e(asset('assets/img/partner-7.png')); ?>"
                                        class="img-fluid partner_img" alt="partner">
                                </div>
                                <div class="partner5">
